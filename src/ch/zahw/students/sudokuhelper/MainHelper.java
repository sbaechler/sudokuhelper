...
//                }
	...
	/**
	 * Extracts the sudoku values from the String returned from the
	 * capture activity
	 */
	...
	private void showNumberPicker(){
	     ...
	     Button bOk = (Button) d.findViewById(R.id.button_ok);
	     Button bClear = (Button) d.findViewById(R.id.button_clear);
