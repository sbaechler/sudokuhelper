...
//	http://www.sudoku-solutions.com/
	public void testSimpleSudoku() {
	    ...
	    assertTrue("The first row of simpleSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{0,5,0,7,0,0,9,0,0};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row of simpleSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of simpleSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{4,5,2,7,3,6,9,8,1};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of simpleSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testSimpleSudoku2() {
	    ...
	    assertTrue("The first row of simpleSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{ 0,0,0,0,0,0,0,0,6};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row of simpleSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of simpleSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{3,4,8,7,1,2,5,9,6};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of simpleSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testEasySudoku() {
	    ...
	    assertTrue("The first row of easySudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{0,0,0,5,0,0,0,6,0};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row of easySudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of easySudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{9,1,8,5,4,3,7,6,2};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of easySudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testMediumSudoku() {
	    ...
	    assertTrue("The first row of mediumSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{0,0,0,5,0,2,0,0,3};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row of mediumSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of mediumSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{9,7,1,5,6,2,4,8,3};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of mediumSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testMediumSudoku2() {
	    ...
	    assertTrue("The first row of mediumSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{0,0,0,0,1,0,0,7,5};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row of mediumSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of mediumSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{8,3,4,6,1,2,9,7,5};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of mediumSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testHardSudoku() {
	    ...
	    assertTrue("The first row of hardSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{0,0,0,6,0,0,9,3,0};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row  of hardSudoku is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of hardSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{2,7,8,6,5,4,9,3,1};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of hardSudokuLoesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
...
//	    assertTrue("The ninth row is solved correctly", Arrays.equals(sudokuLoesung.getRowValues(8), sudoku.getRowValues(8)));
	...
	public void testHardSudoku2() {
	    ...
	    assertTrue("The first row of hardSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{5,3,1,0,7,0,0,0,0};
	    sudokuRow = sudoku.getRowValues(8);
	    assertTrue("The ninth row  of hardSudoku2 is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    ...
	    assertTrue("The first row of hardSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
	    
	    referenceRow = new int[]{5,3,1,4,7,9,6,2,8};
	    sudokuRow = sudokuLoesung.getRowValues(8);
	    assertTrue("The ninth row of hardSudoku2Loesung is set correctly", Arrays.equals(referenceRow, sudokuRow));
